...
describe('Login As PM', () => {
  it('Should login as PM, and unlock Rayonics Lock', async () => {
    let driver;
    try {
      ...
      await lockUtlis.scrollToRayonicsLock(driver);
      await lockUtlis.clickRayonicsLock(driver);
