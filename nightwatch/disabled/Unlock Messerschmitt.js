...
describe('Login As PM', () => {
  it('Should login as PM and unlock Messerschmitt Lock', async () => {
    let driver;
    try {
      ...
      await lockUtlis.scrollToMstLock(driver);
      await lockUtlis.clickMstLock(driver);
